...
| Management candidates | Canonical bootstrap management provider lacks production roll/CC candidate injection | Real exact-contract Alpaca alternative arrays, rejected reasons, no-submit HOLD/CLOSE/ROLL/CC lifecycle proof |
