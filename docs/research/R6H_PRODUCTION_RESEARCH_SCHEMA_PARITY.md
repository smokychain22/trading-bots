...
| Dataset export identity | `datasetExportVersion = "theta-r6-dataset-v2"` (TS constant) | `DATASET_SCHEMA_VERSION` (Python constant, `production_export_loader.py`) | string | n/a | n/a | MATCH | Loader rejects any other value outright |
