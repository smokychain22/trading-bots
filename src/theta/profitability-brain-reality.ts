...
export const profitabilityBrainMethodRegistry: readonly ProfitabilityBrainMethod[] = [
  ...
  method('CROSS_STRATEGY_COMMON_HORIZON_COMPARATOR', 'ECONOMICS', 'RESEARCH_ONLY', 3,
    ['src/research/cross-strategy-common-horizon-contract.ts'],
  ...
  method('PROFIT_TAKING_CHALLENGER_GRID', 'MANAGEMENT', 'RESEARCH_ONLY', 3,
    ['src/research/profit-taking-experiment.ts']),
