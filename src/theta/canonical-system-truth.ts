...
export const canonicalSystemCapabilities: readonly SystemCapabilityTruth[] = [
  ...
  capability({ capabilityId: 'COMPANY_EVENT_AND_CORPORATE_ACTION', layerIds: [7, 9], sourceImplemented: 'YES', testsPassed: 'YES',
    ...
    currentBlocker: 'Complete prospective company-event and corporate-action negative assurance is not established; no Paper fallback policy is promoted.',
    safeCurrentBehavior: 'Positive PIT evidence is honored, absent rows stay unknown and entry remains blocked when safety needs a negative.',
    closureTest: 'Document a supported complete source or approve and test a bounded provider-limited Paper policy.',
    disposition: 'TRUE_HARD_BLOCKER' }),
  ...
  capability({ capabilityId: 'UNKNOWN_READINESS_GOVERNANCE', layerIds: [0, 20], sourceImplemented: 'YES', testsPassed: 'YES',
    ...
    currentBlocker: 'The UNKNOWN audit is PARTIAL, with open provider-limited safety and Paper-entry states.',
