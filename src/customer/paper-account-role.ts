...
export async function designateConnectedPaperMaster(
  ...
  return {
    ...
    masked_broker_identity: `••••${verification.account.id.slice(-4)}`,
    equity: verification.account.equity ?? null,
    cash: verification.account.cash ?? null,
    buying_power: verification.account.buying_power ?? null,
    options_buying_power: verification.account.options_buying_power ?? null,
    options_approved_level: verification.account.options_approved_level ?? null,
    options_trading_level: verification.account.options_trading_level ?? null,
    position_count: verification.positions.length,
    open_order_count: verification.openOrders.length,
    market_open: verification.marketOpen,
    market_clock_timestamp: verification.marketClockTimestamp,
