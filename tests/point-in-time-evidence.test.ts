...
test('dataset export ordering and identity are deterministic',()=>{
  ...
  const base={sourceWindow:{start:'2026-09-01T00:00:00Z',end:'2026-09-12T00:00:00Z'},
    ...
    rows:{candidateSets:[],candidates:[a,b],shadowCandidates:[],strategyFrontiers:[],optionChainDecisions:[],managementSnapshots:[],lifecycleOutcomes:[],wholeChainOutcomes:[],executionEvidence:[],outcomeSubjects:[],outcomeObservations:[],outcomeResolutionReceipts:[],resolvedOutcomeLabels:[],policyLearningRecords:[],positionPathCheckpoints:[],actionInactionFrontiers:[],strategyTimingSnapshots:[]}};
...
test('dataset identity survives JSON serialization of PostgreSQL Date objects',()=>{
  const artifact=buildDatasetExport({
    ...
    rows:{candidateSets:[{decisionTime:new Date('2026-09-10T14:30:00Z')}],candidates:[],shadowCandidates:[],
      strategyFrontiers:[],optionChainDecisions:[],managementSnapshots:[],lifecycleOutcomes:[],wholeChainOutcomes:[],executionEvidence:[],outcomeSubjects:[],outcomeObservations:[],outcomeResolutionReceipts:[],resolvedOutcomeLabels:[],policyLearningRecords:[],positionPathCheckpoints:[],actionInactionFrontiers:[],strategyTimingSnapshots:[]},
  });
...
test('feature side cannot contain future labels even when outcome tables are separate',()=>{
  ...
  assert.throws(()=>buildDatasetExport({sourceWindow:{start:'2026-09-01T00:00:00Z',end:'2026-09-12T00:00:00Z'},
    exportedAt:'2026-09-12T01:00:00Z',featureSetVersion:'f1',strategyVersions:['s1'],rows:{candidateSets:[],
      ...
      wholeChainOutcomes:[],executionEvidence:[],outcomeSubjects:[],outcomeObservations:[],outcomeResolutionReceipts:[],resolvedOutcomeLabels:[],policyLearningRecords:[],positionPathCheckpoints:[],actionInactionFrontiers:[],strategyTimingSnapshots:[]}}),/FUTURE_LABEL_IN_FEATURE_PAYLOAD/);
});
