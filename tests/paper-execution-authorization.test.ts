...
const activation=()=>({activatedAt:'2026-09-18T15:00:00.000Z',runtime:{brokerAccountStatus:'ACTIVE',brokerPositionCount:0,
  ...
  quoteReady:true,latestCompleteScanAt:'2026-09-18T14:55:00.000Z',migrationHead:'059_paper_restart_recovery_invariant'}});
...
test('first canary activation cannot bypass the environment pause or schema head',()=>{
  ...
  assert.deepEqual(blockers,['ENVIRONMENT_NEW_ENTRY_PAUSE_ACTIVE','PRODUCTION_SCHEMA_HEAD_NOT_059']);
});
