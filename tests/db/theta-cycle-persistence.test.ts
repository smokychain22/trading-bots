      ...
      orchestration: {
        ...
        thetaQ: { contractVersion: 'theta-q-runtime-v1', fusionSnapshotHash: fusion.contentHash,
          candidates: [{ candidateId: contract.optionSymbol, rank: 1, actionFeasible: false, quantity: 0,
            ...
            ownershipScore: null, eligibilityBasis: 'INELIGIBLE' as const, reasons: [{ code: 'EDGE_UNKNOWN', polarity: -1 as const, detail: 'Validated outcome probability is unavailable.' }] }],
