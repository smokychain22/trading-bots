...
const state = (lifecycleState: string, overrides: Record<string, unknown> = {},
  ...
  reconciliation_quality:'GOOD',broker_option_symbol:lifecycleState==='CSP_OPEN'?'AAPL261016P00200000':null,
  broker_option_quantity:lifecycleState==='CSP_OPEN'?'1':null,
  broker_option_side:lifecycleState==='CSP_OPEN'?'short':null,
  broker_option_asset_class:lifecycleState==='CSP_OPEN'?'us_option':null,
  broker_option_observed_at:lifecycleState==='CSP_OPEN'?observedAt:null,
  ledger_option_contract_quantity:lifecycleState==='CSP_OPEN'?'1':'0',
