...
import { optionomicsFamiliesFor, optionomicsFeatureDestinationAuthority } from '../src/theta/optionomics-feature-destinations.js';
...
test('routes Optionomics families by strategy rather than feeding every family everywhere', () => {
  ...
  assert.deepEqual(optionomicsFeatureDestinationAuthority,{
    authority:'RESEARCH_SHADOW_ONLY',brokerAuthority:false,
  });
});
