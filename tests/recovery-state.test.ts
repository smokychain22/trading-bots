...
const completeChain: WholeChainComponents = {
  cashflowBasis:'ACTUAL_FILL_CASHFLOW',initialPutPremium:300,putCloseCosts:0,rollCredits:50,rollCloseCosts:20,assignmentStrike:195,stockSharesAssigned:100,
  dividends: 0, coveredCallPremium: null, coveredCallCloseCosts: null, stockSaleOrCallAwayProceeds: null,
  fees:3,executionCostNotEmbeddedInCashflows:1,tcaExecutionShortfall:4,currentStockMarkPerShare:180,openStockShares:100,
};
...
test('with incomplete wholeChainComponents, canonicalEffectiveBasisPerShare/canonicalDistanceToBasisFraction stay null (never fabricated from partial data), and the reason names exactly which component was missing', () => {
  const incompleteChain: WholeChainComponents = {
    cashflowBasis:'ACTUAL_FILL_CASHFLOW',initialPutPremium:null,putCloseCosts:null,rollCredits:null,rollCloseCosts:null,assignmentStrike:195,stockSharesAssigned:100,
    dividends: 0, coveredCallPremium: null, coveredCallCloseCosts: null, stockSaleOrCallAwayProceeds: null,
    fees:3,executionCostNotEmbeddedInCashflows:null,tcaExecutionShortfall:null,currentStockMarkPerShare:180,openStockShares:100,
  };
