...
def run_theta_empirical_pipeline(
    ...
    # The v1 outcome row has no branch field. Assigning every outcome to the
    # caller's configured branch would fabricate lineage, so branch-resolved
    # outcome counts remain empty until a defensible join is exported.
